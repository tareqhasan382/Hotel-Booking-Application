...
<div className="max-w-[1280px] mx-auto overflow-x-hidden bg-rose-300 ">
      <div className=" py-10 ">
        <div className=" my-10 ">
          ...
          <p className="headerDesc">
            Get rewarded for your travels U+2013 unlock instant savings of 10%
            or more with a free Lamabooking account
          </p>
        </div>

        <div className="headerSearch bg-white lg:py-1 py-4   outline outline-2 outline-black rounded-md px-2 flex flex-row  items-center justify-between lg:mx-10 mx-3 lg:h-10 md:h-48 ">
          <div className="grid lg:grid-cols-3 md:grid-cols-1 gap-4 ">
            <div className="headerSearchItem flex flex-row items-center ">
            ...
            <div className="headerSearchItem flex flex-row items-center gap-5 ">
