  ...
  return (
    <section className="flex flex-col md:flex-row items-center gap-12 container w-full   py-10">
      <div className=" md:w-1/2">
        ...
        <h1 className=" gradient-text text-transparent color-animation lg:text-5xl text-3xl font-bold mb-4 ">
        ...
        <button className="px-4 md:px-8 py-2 md:py-3 bg-[#0b0d1c] rounded-lg md:rounded-2xl shadow-sm text-white font-bold text-base md:text-xl hover:scale-110 duration-300 transition-transform">
          Get Started
        </button>
